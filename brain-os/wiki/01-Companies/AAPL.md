...
Apple Inc. is a Technology business scoring 74/100 on the company ranking model — backed by 49.57% ROIC, 47.86% gross margin, 22.7% EPS growth, 0.8 D/E. It holds a 10% allocation target in the investment plan, with 65% of capital currently deployed toward that goal. Meets Buffett/Lynch quality-compounder criteria for ROIC, margins, and growth.

## Bull Case

- Raises portfolio's average capital efficiency
- Earnings compounding supports the 3–5 year thesis
- Self-funding business — no external capital required
